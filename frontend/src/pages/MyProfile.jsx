        ...
        <div className='max-w-lg flex flex-col gap-2 text-sm pt-5'>
            ...
            <div>
                ...
                <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-gray-600'>
                    ...
                    {isEdit
                        ? <input className='max-w-20 bg-gray-50' type='number' min="1" max="120" onChange={(e) => setUserData(prev => ({ ...prev, age: e.target.value }))} value={userData.age || ''} />
                        : <p className='text-gray-500'>{userData.age || 'Not specified'}</p>
                    }
