                        ...
                        <div className='flex flex-col gap-2 justify-end text-sm text-center'>
                            {!item.cancelled && !item.payment && !item.isCompleted && (
                                <button 
                                    ...
                                    className='text-white bg-gradient-to-r from-primary to-primary-dark sm:min-w-48 py-2 border rounded-full hover:shadow-lg hover:scale-105 transition-all duration-300'
                            ...
                            {!item.cancelled && item.payment && !item.isCompleted && (
                                <button className='sm:min-w-48 py-2 border rounded text-green-600 bg-green-50 border-green-200'>
                                    ✓ Paid
                                </button>
                            )}
                            {item.isCompleted && (
